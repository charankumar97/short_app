...
class GeneralEnquiry extends StatefulWidget {
  const GeneralEnquiry({super.key});

  @override
  State<GeneralEnquiry> createState() => _GeneralEnquiryState();
}
    ...
    if(nameError == null &&
      ...
      try{
        final response = await http.post(
          Uri.parse('https://www.staging.cakesandbakes.net/api/send-contact-mail'),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      20.verticalSpace,
                      Text(
                        'If you have any questions, enquiries or comments write a message to us',
                        style: TextStyle(
                          color: Color(0xFF000000),
                          fontSize: 35.rt,
                          fontWeight: FontWeight.w500
